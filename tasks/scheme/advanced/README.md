...
Последней частью этого задания является реализация сборки мусора с учетом циклических ссылок. Мы предлагаем пользоваться техникой **Mark & Sweep**, которая также будет обсуждаться на семинарах.
